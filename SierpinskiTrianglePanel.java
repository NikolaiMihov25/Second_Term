...
public class SierpinskiTrianglePanel extends JPanel {
		...
		private static void displayTriangles(Graphics g, int order, Point p1, Point p2, Point p3) {
			if (order == 0) {
				...
				green +=2;
				color(g,  p1,  p2,  p3, new Color(0, green, 255));
			} else {
		...
		private static void color (Graphics g, Point p1, Point p2, Point p3, Color color) {
			int a[] = {p1.x, p2.x, p3.x};
			int b[] = {p1.y, p2.y, p3.y};
			int nPoints = 3;
